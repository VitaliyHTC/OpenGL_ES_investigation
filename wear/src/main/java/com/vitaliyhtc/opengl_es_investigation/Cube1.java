...
import com.vitaliyhtc.opengl_es_investigation.utils.OpenGLES20Utils;
import com.vitaliyhtc.opengl_es_investigation.utils.ShaderUtils;
import com.vitaliyhtc.opengl_es_investigation.utils.TextureUtils;
...
public class Cube1 {
    ...
    private void bindData() {
        ...
        GLES20.glUniform1f(uLightAmbientIntensityLocation, 0.3f);
        GLES20.glUniform1f(uLightDiffuseIntensityLocation, 0.7f);
        GLES20.glUniform3f(uLightDirectionLocation, 0.0f, 1.0f, -1.0f);
        GLES20.glUniform1f(uLightSpecularIntensityLocation, 0.1f);
        GLES20.glUniform1f(uLightShininessLocation, 5.0f);

 ...
 * tutorial:
 * http://startandroid.ru/ru/uroki/vse-uroki-spiskom/403-urok-173-opengl-kamera.html
 */

public class OpenGLRenderer173 implements Renderer {
    ...
    public OpenGLRenderer173(Context context) {
    ...
    public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
        ...
        int vertexShaderId = ShaderUtils.createShader(context, GL_VERTEX_SHADER, R.raw.vertex_shader173);
        int fragmentShaderId = ShaderUtils.createShader(context, GL_FRAGMENT_SHADER, R.raw.fragment_shader173);

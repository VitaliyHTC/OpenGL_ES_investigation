 ...
 * tutorial:
 * http://startandroid.ru/ru/uroki/vse-uroki-spiskom/405-urok-174-opengl-model.html
 */

public class OpenGLRenderer174 implements Renderer {
    ...
    public OpenGLRenderer174(Context context) {
    ...
    public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
        ...
        int vertexShaderId = ShaderUtils.createShader(context, GL_VERTEX_SHADER, R.raw.vertex_shader174);
        int fragmentShaderId = ShaderUtils.createShader(context, GL_FRAGMENT_SHADER, R.raw.fragment_shader174);

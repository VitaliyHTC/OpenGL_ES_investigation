...
public class OpenGLRenderer176 implements Renderer {
    ...
    public OpenGLRenderer176(Context context) {
    ...
    private void createAndUseProgram() {
        int vertexShaderId = ShaderUtils.createShader(context, GL_VERTEX_SHADER, R.raw.vertex_shader176);
        int fragmentShaderId = ShaderUtils.createShader(context, GL_FRAGMENT_SHADER, R.raw.fragment_shader176);

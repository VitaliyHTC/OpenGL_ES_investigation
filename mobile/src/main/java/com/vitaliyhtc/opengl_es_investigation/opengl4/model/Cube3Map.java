...
public class Cube3Map {
    ...
    private int uUniform12Location;
    private int uUniform13Location;
    private int uUniform14Location;
    private int uUniform15Location;
    private int uUniform16Location;
    private int uUniform17Location;
    private int uUniform18Location;
    private int uUniform19Location;
    private int uUniform20Location;
    private int uUniform21Location;
    private int uUniform22Location;
    ...
    public Cube3Map(Context context,
                    int textureResId,
                    MaterialLightMapSpec materialLightSpec,
        ...
        String vertexShaderCode = ShaderUtils.readShaderFileFromRawResource(context, R.raw.vertex_shader_4_cube3);
        String fragmentShaderCode = ShaderUtils.readShaderFileFromRawResource(context, R.raw.fragment_shader_4_cube3map);
    ...
    private void getLocations() {
        ...
        uUniform12Location = GLES20.glGetUniformLocation(mProgram, "u12");
        uUniform13Location = GLES20.glGetUniformLocation(mProgram, "u13");
        uUniform14Location = GLES20.glGetUniformLocation(mProgram, "u14");
        uUniform15Location = GLES20.glGetUniformLocation(mProgram, "u15");
        uUniform16Location = GLES20.glGetUniformLocation(mProgram, "u16");
        uUniform17Location = GLES20.glGetUniformLocation(mProgram, "u17");
        uUniform18Location = GLES20.glGetUniformLocation(mProgram, "u18");
        uUniform19Location = GLES20.glGetUniformLocation(mProgram, "u19");
        uUniform20Location = GLES20.glGetUniformLocation(mProgram, "u20");
        uUniform21Location = GLES20.glGetUniformLocation(mProgram, "u21");
        uUniform22Location = GLES20.glGetUniformLocation(mProgram, "u22");
    }
    ...
    private void bindData() {
        ...
        GLES20.glUniform1f(uUniform12Location, 12.0f);
        GLES20.glUniform1f(uUniform13Location, 13.0f);
        GLES20.glUniform1f(uUniform14Location, 14.0f);
        GLES20.glUniform1f(uUniform15Location, 15.0f);
        GLES20.glUniform1f(uUniform16Location, 16.0f);
        GLES20.glUniform1f(uUniform17Location, 17.0f);
        GLES20.glUniform1f(uUniform18Location, 18.0f);
        GLES20.glUniform1f(uUniform19Location, 19.0f);
        GLES20.glUniform1f(uUniform20Location, 20.0f);
        GLES20.glUniform1f(uUniform21Location, 21.0f);
        GLES20.glUniform1f(uUniform22Location, 22.0f);
    }

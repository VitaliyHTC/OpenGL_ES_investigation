package com.vitaliyhtc.opengl_es_investigation.opengl3.model;
...
public class Cube3Map {
    ...
    public Cube3Map(Context context,
        ...
        String fragmentShaderCode = ShaderUtils.readShaderFileFromRawResource(context, R.raw.fragment_shader_3_cube3map);
